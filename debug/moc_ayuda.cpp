...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ayuda_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ayuda_t qt_meta_stringdata_ayuda = {
    {
QT_MOC_LITERAL(0, 0, 5) // "ayuda"
...
QT_INIT_METAOBJECT const QMetaObject ayuda::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ayuda.data,
    qt_meta_data_ayuda,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *ayuda::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ayuda.stringdata0))
